...
class EventResourceIT {
    ...
    private static final Instant DEFAULT_DATE_EVENT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_EVENT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().dateEvent(DEFAULT_DATE_EVENT).nameEvent(DEFAULT_NAME_EVENT);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().dateEvent(UPDATED_DATE_EVENT).nameEvent(UPDATED_NAME_EVENT);
        return event;
    }
    ...
    void createEvent() throws Exception {
        ...
        assertThat(testEvent.getNameEvent()).isEqualTo(DEFAULT_NAME_EVENT);
    }
    ...
    @Test
    @Transactional
    void checkNameEventIsRequired() throws Exception {
        int databaseSizeBeforeTest = eventRepository.findAll().size();
        // set the field null
        event.setNameEvent(null);
    ...
    void putNewEvent() throws Exception {
        ...
        updatedEvent.dateEvent(UPDATED_DATE_EVENT).nameEvent(UPDATED_NAME_EVENT);
        ...
        assertThat(testEvent.getNameEvent()).isEqualTo(UPDATED_NAME_EVENT);
    }
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.nameEvent(UPDATED_NAME_EVENT);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.dateEvent(UPDATED_DATE_EVENT).nameEvent(UPDATED_NAME_EVENT);
