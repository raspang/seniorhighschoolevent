...
describe('EventStudent Management Component', () => {
  let comp: EventStudentComponent;
  let fixture: ComponentFixture<EventStudentComponent>;
  let service: EventStudentService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'event-student', component: EventStudentComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(EventStudentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.eventStudents?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
